...
namespace rocketfellows\DEVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\DEVatNumberFormatValidatorsConfig\DEVatNumberFormatValidatorsConfig;

class DEVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = DEVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = DEVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::DE(), $config->getCountry());
    }
